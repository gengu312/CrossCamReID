...
echo.
if not "%EXIT_CODE%"=="0" (
  powershell -NoProfile -Command "[Console]::OutputEncoding=[Text.Encoding]::UTF8; Write-Host (([Text.Encoding]::UTF8.GetString([Convert]::FromBase64String('5pGE5YOP5aS05YCJ5ZCO57qXIOW3sumAgOWHuu+8jOmAgOWHuuegge+8mg=='))) + '%EXIT_CODE%')"
)
